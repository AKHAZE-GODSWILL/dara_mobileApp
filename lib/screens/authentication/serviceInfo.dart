...
class _Service_Info extends State<Service_Info>{
                    ...
                    children: [
                      Padding(
                        ...
                        child: CircularPercentIndicator(
                                      ...
                                      center: new Text(
                                        "60%",
                                        style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 20.0),
                                      ),
                        ...
                        child: TextFormField(
                          ...
                          inputFormatters: [
                            ...
                            TextInputFormatter.withFunction((oldValue, newValue) {
                              return customInputFormatter(oldValue, newValue, maxWordCount);
                            })
                          ],
              ...
              Padding(
                ...
                child: Container(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Services", style: GoogleFonts.inter(
                        fontSize: 12,
                        color: Color(0XFF6B7280)),),
                      SizedBox(height: 5,),
                      Container(
                      ...
                      child: Padding(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton2(
                            ...
                            onChanged: (value) {
                              setState(() {
                                dropdownValueExperience = value as String;
                              });
                            },
                            buttonHeight: 40,
                            buttonWidth: 140,
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: (
                                ...
                                || dropdownvalueServices == null
                                || dropdownvalueSkills == null
                                || dropdownValueExperience == null)? Color(0XFFF3F4F6): constants.appMainColor,
                            ...
                            child: Center(
                              ...
                              :Text(
                                ...
                                || dropdownvalueServices == null
                                || dropdownvalueSkills == null
                                || dropdownValueExperience == null)? Color(0XFF6B7280):Colors.white,
                                  fontSize: 14),),
                            ),
                          ),
                        ),
  ...
  TextEditingValue customInputFormatter(TextEditingValue oldValue, TextEditingValue newValue, int maxWordCount) {
