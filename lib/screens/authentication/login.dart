                  ...
                  child: Align(
                    ...
                    child: InkWell(
                      ...
                      child: Text(
                        "Forgot Password?",
                        style: GoogleFonts.inter(
                            fontSize: 12, color: constants.appMainColor),
                      ),
                    ),
                  ),
                ),
                              ...
                              loginServiceProvider(
                                ...
                                if (value["status"] == true &&
                                  ...
                                  if (provider.userType == "serviceProvider" &&
                                    ...
                                    provider.set_sp_phone(
                                        service_provider_phone:
                                            value["user_object"]
                                                    ["personal_information"]
                                                ["phone"]);
                                    getX.write(constants.GETX_TOKEN,
                                        value["access_token"]);

                                    if (value["user_object"]
                                                ["address_information"] !=
                                            null ||
                                        value["user_object"]
                                                ["service_information"]
                                    ...
                                    getX.write(constants.GETX_SP_PASSWORD,
                                        encryptedPassword);
                                    getX.write(
                                        constants.GETX_SP_PHONE,
                                        (dropDownLoginField == "Phone")
                                            ? "${countryCallingCode}${phone}"
                                            : emailController.text.trim());
                                  } else {
                                    mywidgets.displayToast(
                                        msg:
                                            "This account is registered as a client. Select the Client Option as User type and Login again");
                                  }
                              ...
                              loginClient(
                                ...
                                if (value["status"] == true &&
                                  ...
                                  if (provider.userType == "client" &&
                                    ...
                                    String encryptedPassword = encryptPassword(
                                        passwordController.text.trim());
                                    getX.write(constants.GETX_CLIENT_PASSWORD,
                                        encryptedPassword);
                                    getX.write(
                                      constants.GETX_CLIENT_EMAIL,
                                      emailController.text.trim(),
                                    );
                                  } else {
                                    mywidgets.displayToast(
                                        msg:
                                            "This account is registered as a Service Provider. Select the Service Provider Option as User type and Login again");
                                  }
                                } else if (value["status"] == "Network Error") {
                                  mywidgets.displayToast(
                                      msg:
