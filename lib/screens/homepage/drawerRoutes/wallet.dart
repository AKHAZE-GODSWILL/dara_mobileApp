            ...
            Padding(
              ...
              child: Container(
                ...
                child: ListView.builder(
                 ...
                 return (index %2 == 0)? incomeCard():withdrawalCard();
                })
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Text("Fumigation project charge from Daniel Smith ",
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            // color: Colors.green,
                                            width: MediaQuery.of(context).size.width*0.5,
                                            child: Text("You made a withdrawal into your bank account",
                                              style: TextStyle(fontSize: 12,
                                                  fontWeight: FontWeight.bold,
                                                  color: Color(0XFF374151)),
                                            ),
