          ...
          Padding(
            ...
            child: Container(
              child: Column(
                ...
                children: [
                  Text("Current Password", style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                  SizedBox(height: 5,),
                  Container(
                    height: 48,
                    decoration: BoxDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide.none, // Remove the border when enabled
                        ...
                        suffixIcon: IconButton(
                          ...
                          icon: isCurrentPasswordObscured? Icon(Icons.visibility): Icon(Icons.visibility_off),
                          onPressed: (){
                            setState(() {
          ...
          Padding(
            ...
            child: Container(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("New Password", style: TextStyle(fontSize: 12,fontWeight: FontWeight.bold),),
                  SizedBox(height: 5,),
                  Container(
                    height: 48,
                    decoration: BoxDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide.none, // Remove the border when enabled
                        ...
                        suffixIcon: IconButton(
                          padding: EdgeInsetsDirectional.only(end:12),
                          icon: isNewPasswordObscured? Icon(Icons.visibility): Icon(Icons.visibility_off),
                          onPressed: (){
                            setState(() {
          ...
          Padding(
            ...
            child: Container(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Retype Password", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                  SizedBox(height: 5,),
                  Container(
                    height: 48,
                    decoration: BoxDecoration(
                    ...
                    enabledBorder: OutlineInputBorder(
                      borderSide: BorderSide.none, // Remove the border when enabled
                        ...
                        suffixIcon: IconButton(
                          padding: EdgeInsetsDirectional.only(end:12),
                          icon: isRetypePasswordObscured? Icon(Icons.visibility): Icon(Icons.visibility_off),
                          onPressed: (){
                            setState(() {
                    ...
                    InkWell(
                      onTap: (){
                        ...
                        if(currentPasswordController!.text.isNotEmpty 
                          ...
                          if(newPasswordController.text.trim() != retypePasswordController.text.trim()){
                            mywidgets.displayToast(msg: "New Password and Retype password must match");
                            setState(() {
                              isLoading = false;
                            });
                          }
                              ...
                              String currentPassword = (provider.userType == "serviceProvider")? decryptPassword(getX.read(constants.GETX_SP_PASSWORD)):decryptPassword(getX.read(constants.GETX_CLIENT_PASSWORD));

                              if(currentPassword == currentPasswordController!.text.trim()){
                                //make the request to change password here

                                // makes the request here
                          resetPassword(
                            newPassword: newPasswordController.text.trim(),
                             confirmedPassword: retypePasswordController.text.trim(),
                             user_id: (provider.userType == "serviceProvider")? provider.sp_user_id:provider.client_user_id
                             ).then((value) {
                            ...
                            if(value["status"]== true){
                                  ...
                                  String encryptedPassword = encryptPassword(currentPasswordController.text.trim());

                                  getX.write((provider.userType == "serviceProvider")? constants.GETX_SP_PASSWORD:constants.GETX_CLIENT_PASSWORD, encryptedPassword );
                                  mywidgets.displayToast(msg: "Password changed successfully");
                                  Navigator.pop(context);
                            }
                            ...
                            setState(() {
                              isLoading = false;
                                ...
                                mywidgets.displayToast(msg: "Current Password is Incorrect. Click forgot Password to change your password");
                              }
                          }
                        }
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: (currentPasswordController.text.isEmpty 
                                  ...
                                  || retypePasswordController.text.isEmpty)? Color(0XFFF3F4F6): constants.appMainColor,
                        ...
                        child: Center(
                          ...
                          :Text(
                            ...
                            style: TextStyle(
                              color: (currentPasswordController.text.isEmpty 
                                  || newPasswordController.text.isEmpty
                                  || retypePasswordController.text.isEmpty)? Color(0XFF6B7280):Colors.white,
                              fontSize: 14),),
                        ),
                      ),
                    ),
