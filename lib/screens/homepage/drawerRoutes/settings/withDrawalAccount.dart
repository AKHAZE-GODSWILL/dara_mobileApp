          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 10),
                      child: Text(
                        "Add your bank account to specify where you would like your withdrawn funds to be deposited.",
                ...
                InkWell(
                  onTap: () {
                    provider.setBankDetails(
                        nameOfBank: dropdownvalueBankName ?? "First Bank",
                        accNumber: (accountNumberController.text.isNotEmpty)
                            ? accountNumberController.text.trim()
                            : "0100000002000");

                    provider.setSecurityDetails(
                        securedQuestion: dropdownvalueSecurityQuestion ??
                            "What is your Mother's Maiden Name",
                        securedAnswer:
