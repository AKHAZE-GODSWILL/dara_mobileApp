                ...
                Padding(
                  ...
                  child: InkWell(
                            onTap: (){
                              ...
                              createPost(imageFiles: mediaFiles, body: _captionController.text.trim(), token: provider.sp_token!).then((value) {
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: (isLoading)? Center(child: CircularProgressIndicator(color: Colors.grey,),): Text(
                                  "Post",
                                  style: TextStyle(
          ...
          children: [
            ...
            Container(
              ...
              child: GridView.builder(
                ...
                itemCount: mediaFiles.length, // Replace with the length of your data
                itemBuilder: (BuildContext context, int index) {
                  return customMediaWidget(filePath: mediaFiles[index].path, index: index);
                },
              )
                ...
                child: Row(
                  ...
                  children: [
                    InkWell(
                            onTap: (){
                              // selectMultiImages();
                             (photoCount== 30)? Fluttertoast.showToast(msg: "You can only post up to 30 photos"): getImageGallerys();
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: 20,
                                      alignment: Alignment.center,
                                      child: SvgPicture.asset("assets/svg/post-image.svg"),
                                    ),
                                    SizedBox(width: 5,),
                                    Text(
                                      "Image",
                          ...
                          InkWell(
                            onTap: (){
                              (videoCount == 20)?Fluttertoast.showToast(msg: "You can only post up to 20 videos"): getVideoGallery();
                            },
                            child: Container(
                              width: 120,
                              height: 41,
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      width: 20,
                                      alignment: Alignment.center,
                                      child: SvgPicture.asset("assets/svg/post-video.svg"),
                                    ),
                                    SizedBox(width: 5,),
                                    Text(
                                      "Video",
  ...
  getImageGallerys() {
    ImagePicker().pickMultiImage().then((selectedImage) {
      ...
      setState(() {
       ...
       (photoCount< 30)? selectedImage.forEach((image) {
